...
Input username
    [Arguments]    ${username}
    Input Text  //html/body/div[2]/div/div/div/div/div[2]/div/form/div[1]/input  9740105480   ${username}

Input password
    [Arguments]    ${password}
    Input Text  //html/body/div[2]/div/div/div/div/div[2]/div/form/div[2]/input  bismillah  ${password}
